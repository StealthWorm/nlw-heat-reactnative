...
export function MessageList() {
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={styles.content} //style do conteudo da ScrollView
      keyboardShouldPersistTaps="never"      //prop. para quando clicar na lista ele fecha o teclado, caso esteja aberto
    >
